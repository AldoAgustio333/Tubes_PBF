                ...
                <ul class="menu text-xl font-semibold">
                    ...
                    <li><a href="/dashboard/absensi">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-check" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <path d="M13 13l2 2l2 -2" />
                                <path d="M13 17l2 2l2 -2" />
                            </svg>
                            Absensi</a></li>
                    <li><a href="/dashboard/pertanyaan">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-help-circle" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <path d="M12 16v.01" />
                                <path d="M12 13a2 2 0 0 0 1 -1.988a2.4 2.4 0 0 0 -2 -2.012c-.974 0 -1.86 .596 -2.342 1.578" />
                            </svg>
                            Pertanyaan</a></li>
                </ul>
            </div>
